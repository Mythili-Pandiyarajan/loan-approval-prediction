...
if submitted:
    ...
    if not hard_stop:
        ...
        emi_monthly_rs = loan_amount * cfg["loan_amount_unit"] / loan_term  # rough display

        if emi_ratio > threshold:
            hard_stop = True
    ...
    <div style="margin-bottom:0.3rem;">
        ...
        <span style="font-family:'Syne',sans-serif;font-size:1.1rem;font-weight:700;
                     color:{bar_color};float:right;">{risk_score}%</span>
    </div>
    ...
    <div class="metric-row">
        ...
        <div class="metric-box">
            ...
            <div class="metric-value">{loan_to_income_ratio:.1f}x</div>
...
<div class="disclaimer">
    ...
    © 2025 LoanSense · Built with Streamlit & XGBoost
</div>
""", unsafe_allow_html=True)