...
def compute_emi(loan_amount, loan_term_months):
    ...
    principal      = loan_amount   # already in rupees
...
with st.form("loan_form"):
    ...
    with f3:
        loan_amount = st.number_input(
            "Loan Amount (₹)", min_value=1000.0, value=120000.0, step=1000.0
        )
    with f4:
...
if submitted:
    ...
    input_data = {
        ...
        "LoanAmount":        float(loan_amount / 1000),  # model trained on thousands
...
<div class="disclaimer">
    ...
    © 2026 LoanSense · Built by Mythili · Streamlit & XGBoost
</div>
""", unsafe_allow_html=True)
